...
public class Xoroshiro128PlusPlusRandom implements AbstractRandom {
    ...
    @Override
    public demo.extracted.RandomDeriver createRandomDeriver() {
    ...
    public void setSeed(long seedLo, long seedHi) {
        this.implementation.setSeed(seedLo, seedHi);
        this.gaussianGenerator.reset();
    }
    ...
    public static class RandomDeriver implements demo.extracted.RandomDeriver {
        ...
        public void reseedRandom(Xoroshiro128PlusPlusRandom random, int x, int y, int z) {
            long l = MathHelper.hashCode(x, y, z);
            long m = l ^ this.seedLo;
            random.setSeed(m, this.seedHi);
        }
